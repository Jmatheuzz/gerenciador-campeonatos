...
async function inicio(){
    ...
    response1.data.torneios.forEach(torneio => {
        torneios.innerHTML += `<div><a onclick="criarTime(this)" href="http://localhost:5500/frontend/show-torneio.html "><h3 id = "nome-torneio"> ${torneio.nome} </h3></a><button class="apagar-torneio" onclick="apagar(this)"> Apagar </button> <button class="atualizar-torneio" onclick="atualizar(this)"> Atualizar </button></div>`
    });
    return torneios;
}
